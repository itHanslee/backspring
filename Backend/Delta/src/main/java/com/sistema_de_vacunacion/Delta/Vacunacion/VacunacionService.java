...
public interface VacunacionService {
    ...
    void registrarAplicacion(RegistrarVacunacionDTO dto, String emailPersonalSalud);

    List<VacunacionResponseDTO> obtenerVacunasAplicadas(Long idCiudadano);

    List<VacunacionResponseDTO> obtenerHistorial(Long idCiudadano);
}