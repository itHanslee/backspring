...
public class Vacunacion {
    ...
    public PersonalSalud getPersonalSalud() { return personalSalud; }
    public void setPersonalSalud(PersonalSalud personalSalud) { this.personalSalud = personalSalud; }

    public InventarioLote getInventario() { return inventario; }
    public void setInventario(InventarioLote inventario) { this.inventario = inventario; }
    ...
    public static class VacunacionBuilder {
        ...
        public VacunacionBuilder ciudadano(Ciudadano ciudadano) { this.ciudadano = ciudadano; return this; }
        public VacunacionBuilder personalSalud(PersonalSalud personalSalud) { this.personalSalud = personalSalud; return this; }
        public VacunacionBuilder inventario(InventarioLote inventario) { this.inventario = inventario; return this; }
        public VacunacionBuilder dosis(Integer dosis) { this.dosis = dosis; return this; }
        public VacunacionBuilder fechaAplicacion(LocalDate fechaAplicacion) { this.fechaAplicacion = fechaAplicacion; return this; }
        public VacunacionBuilder observaciones(String observaciones) { this.observaciones = observaciones; return this; }
        public VacunacionBuilder reaccionesAdversas(boolean reaccionesAdversas) { this.reaccionesAdversas = reaccionesAdversas; return this; }
