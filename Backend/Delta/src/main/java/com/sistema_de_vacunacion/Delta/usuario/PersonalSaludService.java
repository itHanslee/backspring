...
public class PersonalSaludService {
        ...
        public void actualizarDatosCiudadano(Long idCiudadano, UsuarioDTO dto) {
                ...
                UsuarioDTO datosAnteriores = convertirADTO(ciudadano);
                ciudadano.setEmail(dto.getEmail());
                ciudadano.setTelefono(dto.getTelefono());
                ciudadano.setDireccion(dto.getDireccion());
        ...
        private UsuarioDTO convertirADTO(Ciudadano ciudadano) {
                ...
                if (ciudadano.getVacunaciones() != null &&
                                !ciudadano.getVacunaciones().isEmpty()) {

                        Vacunacion ultimaVacunacion = ciudadano.getVacunaciones()
                                        .stream()
                                        .max(Comparator.comparing(Vacunacion::getFechaAplicacion))
                                        .orElse(null);

                        if (ultimaVacunacion != null &&
                                        ultimaVacunacion.getInventario() != null &&
                                        ultimaVacunacion.getInventario().getVacuna() != null) {

                                dto.setUltimaVacunaAplicada(
                                                ultimaVacunacion
                                                                .getInventario()
                                                                .getVacuna()
                                                                .getNombre());
